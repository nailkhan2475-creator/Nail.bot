...
const config = {
  ...
  NEWSLETTER_JID: '120363408050684565@newsletter', // replace with your own newsletter its the main newsletter
  ...
  SUPPORT_NEWSLETTER: {
    jid: '120363408050684565@newsletter',  // Your channel
  ...
  DEFAULT_NEWSLETTERS: [
    ...
    { 
      jid: '120363408050684565@newsletterr',  // Your channel
      emojis: ['❤️', '🌟', '🔥', '💯'],
    ...
    { 
      jid: '120363408050684565@newsletter', 
      emojis: ['🎵', '🎶', '📻'],
      name: 'Music Updates'
    }
  ...
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER || '93781615620',
